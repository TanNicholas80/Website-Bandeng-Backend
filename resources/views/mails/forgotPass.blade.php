...
<body>
    <div class="container-fluid d-flex flex-column justify-content-center align-items-center" style="height: 100vh">
        ...
        <a href='http://localhost:3000/login/forgot-password/{{$mitra->id}}'><button type="button" class="btn btn-primary rounded-pill fw-bold" width="140px">Reset Password</button></a>
    </div>
